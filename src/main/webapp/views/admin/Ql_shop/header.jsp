									...
									<ul>
										<li class="notification-unread"><a
											href="javascript:void()"> <img
												...
												src="img/admin/avatar/1.jpg" alt="">
										...
										<li class="notification-unread"><a
											href="javascript:void()"> <img
												class="float-left mr-3 avatar-img"
												src="img/admin/avatar/2.jpg" alt="">
												<div class="notification-content">
										...
										<li><a href="javascript:void()"> <img
												class="float-left mr-3 avatar-img"
												src="img/admin/avatar/3.jpg" alt="">
												<div class="notification-content">
										...
										<li><a href="javascript:void()"> <img
												class="float-left mr-3 avatar-img"
												src="img/admin/avatar/4.jpg" alt="">
												<div class="notification-content">
			...
			<div class="nk-nav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li class="mega-menu mega-menu-sm"><a class="has-arrow"
						...
						<ul aria-expanded="false">
							<li><a href="./admin-home?page=content_body">Blank</a></li>
