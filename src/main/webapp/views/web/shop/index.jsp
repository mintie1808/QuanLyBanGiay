...
<section class="hero">
	<div class="hero__slider owl-carousel">
		...
		<div class="hero__items set-bg" data-setbg="img/shop/hero/hero-2.jpg">
			<div class="container">
				<div class="row">
					<div class="col-xl-5 col-lg-7 col-md-8">
						<div class="hero__text">
		...
		<div class="row">
			<div class="col-lg-7 offset-lg-4">
				<div class="banner__item">
					<div class="banner__item__pic">
						<img src="img/shop/banner/banner-1.jpg" alt="">
					</div>
			...
			<div class="col-lg-5">
				<div class="banner__item banner__item--middle">
					<div class="banner__item__pic">
						<img src="img/shop/banner/banner-2.jpg" alt="">
					</div>
					<div class="banner__item__text">
						<h2>Accessories</h2>
						<a href="#">Shop now</a>
			...
			<div class="col-lg-7">
				<div class="banner__item banner__item--last">
					<div class="banner__item__pic">
						<img src="img/shop/banner/banner-3.jpg" alt="">
					</div>
					<div class="banner__item__text">
		...
		<div class="row product__filter">
			<div
				...
				<div class="product__item">
					<div class="product__item__pic set-bg"
						data-setbg="img/shop/product/product-1.jpg">
						<span class="label">New</span>
						<ul class="product__hover">
							<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
							<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
									<span>Compare</span></a></li>
							<li><a href="#"><img src="img/shop/icon/search.png" alt=""></a></li>
						</ul>
					</div>
			...
			<div
				...
				<div class="product__item sale">
					<div class="product__item__pic set-bg"
						data-setbg="img/shop/product/product-3.jpg">
			...
			<div
				...
				<div class="product__item">
					<div class="product__item__pic set-bg"
						data-setbg="img/shop/product/product-4.jpg">
						<ul class="product__hover">
							<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
							<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
									<span>Compare</span></a></li>
			...
			<div
				...
				<div class="product__item">
					<div class="product__item__pic set-bg"
						data-setbg="img/shop/product/product-5.jpg">
						<ul class="product__hover">
							<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
							<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
									<span>Compare</span></a></li>
			...
			<div
				...
				<div class="product__item sale">
					<div class="product__item__pic set-bg"
						data-setbg="img/shop/product/product-6.jpg">
						<span class="label">Sale</span>
						<ul class="product__hover">
							<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
							<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
			...
			<div
				...
				<div class="product__item">
					<div class="product__item__pic set-bg"
						data-setbg="img/shop/product/product-7.jpg">
						<ul class="product__hover">
							<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
							<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
									<span>Compare</span></a></li>
			...
			<div
				...
				<div class="product__item">
					<div class="product__item__pic set-bg"
						data-setbg="img/shop/product/product-8.jpg">
						<ul class="product__hover">
							<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
							<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
									<span>Compare</span></a></li>
		...
		<div class="row">
			...
			<div class="col-lg-4">
				<div class="categories__hot__deal">
					<img src="img/shop/product-sale.png" alt="">
			...
			<div class="col-lg-8">
				<div class="instagram__pic">
					<div class="instagram__pic__item set-bg"
						data-setbg="img/shop/instagram/instagram-1.jpg"></div>
					<div class="instagram__pic__item set-bg"
						data-setbg="img/shop/instagram/instagram-2.jpg"></div>
					<div class="instagram__pic__item set-bg"
						data-setbg="img/shop/instagram/instagram-3.jpg"></div>
					<div class="instagram__pic__item set-bg"
						data-setbg="img/shop/instagram/instagram-4.jpg"></div>
					<div class="instagram__pic__item set-bg"
						data-setbg="img/shop/instagram/instagram-5.jpg"></div>
					<div class="instagram__pic__item set-bg"
						data-setbg="img/shop/instagram/instagram-6.jpg"></div>
				</div>
			</div>
			<div class="col-lg-4">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="blog__item">
					<div class="blog__item__pic set-bg"
						data-setbg="img/shop/blog/blog-1.jpg"></div>
					<div class="blog__item__text">
						<span><img src="img/shop/icon/calendar.png" alt=""> 16
							February 2020</span>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="blog__item">
					<div class="blog__item__pic set-bg"
						data-setbg="img/shop/blog/blog-2.jpg"></div>
					<div class="blog__item__text">
						<span><img src="img/shop/icon/calendar.png" alt=""> 21
							February 2020</span>
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="blog__item">
					<div class="blog__item__pic set-bg"
						data-setbg="img/shop/blog/blog-3.jpg"></div>
					<div class="blog__item__text">
						<span><img src="img/shop/icon/calendar.png" alt=""> 28
							February 2020</span>
