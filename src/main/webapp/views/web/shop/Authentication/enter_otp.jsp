	                    ...
	                    <div class="p-4 p-md-5 flex-grow-1">
	                      ...
	                      <div class="row justify-content-center">
	                        <div class="col-sm-8 col-md">
	                          <form action="./ValidateOtp" method="post" class="mb-3"><input class="form-control" id="opt" name="otp" type="number" placeholder="Enter Otp" autocomplete="off"  autofocus required>
	                            <div class="mb-3"></div>
	                               <input type="hidden" name="page" value="otp">
	                            <button class="btn btn-flat btn-login  d-block w-100 mt-3" type="submit" name="submit">Reset Password</button>
