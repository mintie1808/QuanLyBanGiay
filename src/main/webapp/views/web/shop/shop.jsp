			...
			<div class="col-lg-9">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="product__item">
							<div class="product__item__pic set-bg"
								data-setbg="img/shop/product/product-9.jpg">
								<ul class="product__hover">
									<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
									<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
											<span>Compare</span></a></li>
					...
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="product__item sale">
							<div class="product__item__pic set-bg"
								data-setbg="img/shop/product/product-10.jpg">
								<span class="label">Sale</span>
								<ul class="product__hover">
									<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
									<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
					...
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="product__item">
							<div class="product__item__pic set-bg"
								data-setbg="img/shop/product/product-11.jpg">
								<ul class="product__hover">
									<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
									<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
											<span>Compare</span></a></li>
					...
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="product__item sale">
							<div class="product__item__pic set-bg"
								data-setbg="img/shop/product/product-12.jpg">
								<span class="label">Sale</span>
								<ul class="product__hover">
									<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
									<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
					...
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="product__item">
							<div class="product__item__pic set-bg"
								data-setbg="img/shop/product/product-13.jpg">
								<ul class="product__hover">
									<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
									<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
											<span>Compare</span></a></li>
					...
					<div class="col-lg-4 col-md-6 col-sm-6">
						<div class="product__item">
							<div class="product__item__pic set-bg"
								data-setbg="img/shop/product/product-14.jpg">
								<ul class="product__hover">
									<li><a href="#"><img src="img/shop/icon/heart.png" alt=""></a></li>
									<li><a href="#"><img src="img/shop/icon/compare.png" alt="">
											<span>Compare</span></a></li>
