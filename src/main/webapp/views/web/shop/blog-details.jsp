		...
		<div class="row d-flex justify-content-center">
			<div class="col-lg-12">
				<div class="blog__details__pic">
					<img src="img/shop/blog/details/blog-details.jpg" alt="">
				</div>
			</div>
			<div class="col-lg-8">
				<div class="blog__details__content">
					...
					<div class="blog__details__text">
						<p>Hydroderm is the highly desired anti-aging cream on the
							...
							on the skin and keeps the skin younger, tighter and healthier. It
							...
							<div class="col-lg-6 col-md-6 col-sm-6">
								<div class="blog__details__author">
									<div class="blog__details__author__pic">
										<img src="img/shop/blog/details/blog-author.jpg" alt="">
									</div>
