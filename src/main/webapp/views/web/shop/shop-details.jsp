...
<!-- 						<div class="product__details__option">
							...
							<div class="product__details__cart__option">
								<form class="addToCartForm" action="shopcart" method="post">
									...
									<input min="1" max="${data.amount}" type="number" name="quantity" id="quantityInput"
										placeholder="1"> <input type="hidden" name="price"
										value="${data.price}"> <input type="submit"
										value="Add to Cart" onclick="setDefaultQuantity()">
								</form>
	
							<div class="product__details__last__option" style="margin-top: 10px;">
								<h5>
				...
				<div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
					<div class="product__item">
						<div class="product__item__pic set-bg"
							data-setbg="img/shop/product/${listR.img}">
